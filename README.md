...
* **Tool-Using Agent**: The Worker Agent can use a predefined set of tools (e.g., creating orders, fetching product details, updating customer information) to interact with the e-commerce system.
